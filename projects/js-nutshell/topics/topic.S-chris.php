...
<main>
    <div class="container">
        ...
        <!-- EXAMPLE 1 -->
        <div class="codeArea flex-container codeExample mw-100">
        <div class="row">
            <div class="col-md-6 col-sm-12 code px-auto">
...
console.log(intro);</code>
            ...
            <div class="col-md-6 col-sm-12 output px-auto">
                <button class="btn" onclick="S_templateStrings1();">Run</button>
                <button class="btn" onclick="clearResultText(1);">Reset</button>
...
console.log(statement);</code>
            ...
            <div class="col-md-6 col-sm-12 output px-auto">
                <button class="btn" onclick="S_templateStrings2();">Run</button>
                <button class="btn" onclick="clearResultText(2);">Reset</button>
